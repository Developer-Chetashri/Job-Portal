...
<body>
	...
	<div class="container">
		...
		<div class="navbar-collapse collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="" onclick="window.load()">Update Resume</a></li>
	...
	<div class="container">
		<div class="single">
			...
			<form name="form" action="../updatingJobSeekerDetails" method="post">

				<input type="hidden" name="userid"
					value=<%= empid%>>
				
				<input type="hidden" name="updater" value="jobseeker">
					...
					<div class="form-group col-md-12">
						...
						<div class="col-md-9">
							<input type="text" name="firstname" id="firstName"
								class="form-control input-sm" value=<%= rs.getString("firstname")%> />
						</div>
					</div>
				</div>
					...
					<div class="form-group col-md-12">
						...
						<div class="col-md-9">
							<input type="text" name="lastname" id="lastName"
								class="form-control input-sm" value=<%= rs.getString("lastname")%> />
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="form-group col-md-12">
						<label class="col-md-3 control-lable" for="contact">Contact
							Number</label>
						<div class="col-md-9">
							<input type="text" name="contactno" id="contact"
				...
				<div class="row">
					<div class="form-group col-md-12">
						...
						<div class="col-md-9" class="form-control input-sm">
							<div class="radios">
							<% if(rs.getString("gender").toString().equalsIgnoreCase("Male")){ %>
					...
					<div class="form-group col-md-12">
						...
						<div class="col-md-9">
							<input type="date" name="dob" id="dob"
								class="form-control input-sm" value=<%= rs.getString("dob") %> >
						</div>
					</div>
				</div>
				...
				<div class="row">
						<div class="form-group col-md-12">
							<label class="col-md-3 control-lable" for="10-Standard">10<sup>th</sup> Standard</label>
							<div class="col-md-6">
								<input type="text" name="10thSchool" id="10thSchool" 
									class="form-control input-sm" value=<%= rs.getString("school10")%> >
							</div>
							<label class="col-md-1 control-lable" for="10-Percentage">Percentage</label>
							<div class="col-md-2">
								<input type="text" name="10Percentage" id="10Percentage"
									class="form-control input-sm" value=<%= rs.getString("percent10")%> >
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group col-md-12">
							<label class="col-md-3 control-lable" for="12-Standard">12<sup>th</sup> Standard</label>
							<div class="col-md-6">
								<input type="text" name="12thSchool" id="12thSchool" 
									class="form-control input-sm" value=<%= rs.getString("school12")%>  >
							</div>
							<label class="col-md-1 control-lable" for="12-Percentage">Percentage</label>
							<div class="col-md-2">
								<input type="text" name="12ercentage" id="12Percentage"
									class="form-control input-sm" value=<%= rs.getString("percent12")%>  >
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="form-group col-md-12">
						<label class="col-md-3 control-lable" for="education">Higher
							Education</label>
						<div class="col-md-9">
							<input type="text" name="education" id="education"
								class="form-control input-sm" value=<%= rs.getString("education")%> >
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="form-group col-md-12">
						<label class="col-md-3 control-lable" for="email">Address</label>
						<div class="col-md-9">
							<input type="text" name="address" id="address"
								class="form-control input-sm" value=<%= rs.getString("address") %> />
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="form-group col-md-12">
						<label class="col-md-3 control-lable" for="workexp">Work
							Experience</label>
						<div class="col-md-9">
							<select name="workexp" id="workexp" class="form-control input-sm"
								required>
								<option value=<%= rs.getString("workexp") %>><%= rs.getString("workexp") %></option>
				...
				<div class="row">
					<div class="form-group col-md-12">
						<label class="col-md-3 control-lable" for="Skills">Skills
							Resume</label>
						<div class="col-md-9">
							<input type="text" name="skills" id="skills" class="form-control input-sm" value=<%= rs.getString("skills") %>>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="form-group col-md-12">
						<label class="col-md-3 control-lable" for="resume">Upload
							Resume</label>
						<div class="col-md-9">
							<input type="file" name="resume" id="resume" value=<%= rs.getString("resumefile") %>>
						</div>
					</div>
				</div>
