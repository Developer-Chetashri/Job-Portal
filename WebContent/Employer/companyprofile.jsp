	...
	<div class="container">
		...
		<div class="navbar-collapse collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="" onclick="window.load()">Company Profile</a></li>
		...
		<div class="single">
			<div class="form-container">
				...
				<form name="form" action="../updateCompanyProfile" method="post">
					...
					<input type="hidden" name="userid" value=<%= session.getAttribute("username").toString()%>>
					<input type="hidden" name="updater" value="employer">
					<div class="row">
						<div class="form-group col-md-12">
							...
							<div class="col-md-9">
								<input type="text" name="cmpName" id="cmpName"
									class="form-control input-sm" value=<%= rs.getString("cmpname") %>>
							</div>
						</div>
					</div>
