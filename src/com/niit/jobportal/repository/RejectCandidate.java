...
/**
 * Servlet implementation class RejectCandidate
 */
@WebServlet("/RejectCandidate")
public class RejectCandidate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String url = "";
		boolean result = rs.rejectCandidate(jobid, jskid, empid);
		System.out.println(result);
		if (result) {
			url = "Employer/employermain.jsp";
			out.println("<script type=\"text/javascript\">");
			out.println("alert('Candidate is Rejected!')");
			...
			url = "Employer/employermain.jsp";
			out.println("<script type=\"text/javascript\">");
			out.println("alert('Error while Rejecting!')");
			out.println("location='" + url + "';");
			out.println("</script>");
			RequestDispatcher rd = request.getRequestDispatcher(url);
			rd.include(request, response);
