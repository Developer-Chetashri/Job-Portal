...
public class CompanyDetails {
	...
	public void fetchingComanyDetailsThroughJobID(int jobid) throws IOException {
		try {
	...
	public void fetchingCompanyDetails(int CompanyID) throws IOException {
		try {
			Connection con=DbConnector.connect();
	...
	public void fetchingCompanyDetails(String CompanyName) throws IOException {
		try {
			Connection con=DbConnector.connect();
